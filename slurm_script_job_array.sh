...
#SBATCH --output=system1_outputs/output_%N_%j.out  # STDOUT output file
#SBATCH --error=system1_outputs/output_%N_%j.err   # STDERR output file (optional)
...
#SBATCH --array=0-499          # Array job will submit 100 jobs
...
srun python3 /home/bg545/attractor_id/run_experiment.py ${SLURM_ARRAY_TASK_ID}
